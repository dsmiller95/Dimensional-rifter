...
namespace Assets.Tiling.Tilemapping.NEwSHITE
{
    ...
    public class TheReelBigCombinationTileMapManager : MonoBehaviour, ISaveable<WorldSaveObject>
    {
        /// <summary>
